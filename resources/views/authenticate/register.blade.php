			...
			<div class="wrap-login100">
				...
				<form action="{{route('register')}}" method="post" class="login100-form validate-form">
					...
					<div class="form-check d-flex justify-content-between">
						<div>
							<input class="form-check-input" type="radio" name="role" value="employee" id="flexRadioDefault1">
							<label class="form-check-label p-0" for="flexRadioDefault1">
						  	Employee
							</label>
						</div>
						<div>
							<input class="form-check-input" type="radio" name="role" value="employer" id="flexRadioDefault2" checked>
