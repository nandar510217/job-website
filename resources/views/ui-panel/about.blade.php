...
@section('content')
  <!-- Page Content -->
  <div class="page-heading about-heading header-text" style="background-image: url('{{ asset("../ui-panel/assets/images/heading-6-1920x500.jpg") }}');">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="right-image">
            <img src="{{asset('ui-panel/assets/images/about-1-570x350.jpg')}}" alt="">
          </div>
        </div>
        <div class="col-md-6">
