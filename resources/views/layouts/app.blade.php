...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" href="{{asset('ui-panel/assets/images/favicon.ico')}}">
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="{{url("/")}}"><h2>Job Agency <em>Website</em></h2></a>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="right-image">
              <img src="ui-panel/assets/images/about-1-570x350.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="services" style="background-image: url(ui-panel/assets/images/other-image-fullscren-1-1920x900.jpg);" >
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item">
              <a href="#" class="services-item-image"><img src="ui-panel/assets/images/blog-1-370x270.jpg" class="img-fluid" alt=""></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item">
              <a href="#" class="services-item-image"><img src="ui-panel/assets/images/blog-2-370x270.jpg" class="img-fluid" alt=""></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item">
              <a href="#" class="services-item-image"><img src="ui-panel/assets/images/blog-3-370x270.jpg" class="img-fluid" alt=""></a>
